...
{
	/*textures[0].loadFromFile("C:\\Users\\Home\\Desktop\\Works(Cpp)\\Flappy Bird\\images\\birddown.png");*/
	textures[0].loadFromFile("images\\birddown.png");
	textures[1].loadFromFile("images\\birdup.png");
